    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12">
            <div className="text-center mb-12">
                ...
                <h1 className="text-4xl font-black text-white mb-3">About Able Enterprise</h1>
                <p className="text-gray-400 text-lg">Your trusted partner for premium electronics since 2016</p>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-8 mb-8">
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed text-sm">
                    <p>Founded in 2016, Able Enterprise started with a simple idea: make buying premium electronics online easy, affordable, and trustworthy. What began as a small passion project has grown into a platform serving thousands of happy customers.</p>
