            ...
            <div className="w-full max-w-md text-center">
                ...
                <div className="space-y-4">
                    <button
                        ...
                        className="w-full bg-[#004792] hover:bg-[#005bc0] text-white font-bold py-4 rounded-xl transition-all shadow-lg"
                    >
                        Create Account
                    </button>
                    ...
                    <div className="pt-4">
                        <button
                            ...
                            className="text-gray-500 hover:text-[#004792] font-medium transition-colors"
                        >
                            Continue as Guest
                        </button>
                    </div>
