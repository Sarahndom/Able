    ...
    return (
        <div className="max-w-lg mx-auto px-4 py-20 text-center">
            ...
            <div className="bg-gray-800 rounded-2xl p-5 mb-7">
                ...
                <p className="text-white font-mono text-2xl font-black text-blue-400">{orderId}</p>
            </div>
            <div className="flex gap-4 justify-center">
                <button onClick={() => onNav('dashboard')} className="bg-blue-500 hover:bg-blue-400 text-black font-black px-6 py-3 rounded-2xl" style={{ transition: 'background .15s' }}>View Orders</button>
                <button onClick={() => onNav('shop')} className="border border-gray-700 hover:border-blue-500 text-white px-6 py-3 rounded-2xl" style={{ transition: 'border-color .15s' }}>Continue Shopping</button>
            </div>
        </div>
    );
}
